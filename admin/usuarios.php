                    ...
                    <table class="table tablaAlinear">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td>#<?php echo $f['id']; ?></td>
                                    <td><img src="../images/<?php echo $f['img_perfil']; ?>" width="70px" height="70px" alt=""></td>
                                    ...
                                    <td>
                                        ...
                                        data-imagen="<?php echo $f['img_perfil']; ?>" 
                ...
                <form action="../php/editarUsuario.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="descripcion" placeholder="descripcion" id="emailEdit" class="form-control" readonly=»readonly»></input>
                        </div>
                        <div class="form-group">
                            <label for="precioEdit">Teléfono</label>
                            <input type="tel" min="0" name="precio" placeholder="precio" id="telefonoEdit" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="imagen">Nivel de Usuario</label>
                            <select id="nivelEdit" class="form-control">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".btnEditar").click(function() {
                ...
                var imagen = $(this).data('img_perfil');
