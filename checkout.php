          ...
          <div class="row mb-5">
            <div class="col-md-12">
              <div class="border p-4 rounded" role="alert">
                ¿Ya eres cliente? <a href="login.php">Click aquí</a> para iniciar sesion
              </div>
            </div>
          </div>
          <div class="row">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="c_postal_zip" name="c_postal_zip" placeholder="29000" required>
                  </div>
                </div>
            ...
            <div class="col-md-6">
              ...
              <div class="row mb-5">
                <div class="col-md-12">
                  <h2 class="h3 mb-3 text-black">Resumen de tu pedido</h2>
                  <div class="p-3 p-lg-5 border">
                    ...
                    <div class="border p-3 mb-3">
                      <h3 class="h6 mb-0"><input type="radio" name="" id=""><a href=""> Transferencia bancaria</a></h3>
                    </div>

                    <div class="border p-3 mb-3">
                    <h3 class="h6 mb-0"><input type="radio" name="" id=""><a href=""> Bizum</a></h3>
                    </div>

                    <div class="border p-3 mb-5">
                    <h3 class="h6 mb-0"><input type="radio" name="" id=""><a href=""> Paypal</a></h3>
                    </div>
